		...
		<div class="container">
			...
			<form class="form-horizontal" action="pay" method="post" id="payform">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<input type="tel" minlength="11" maxlength="11" class="form-control" name="phone" value="${user.phone}" style="height:auto;padding:10px;" placeholder="输入收货电话" required="required" id="fphone"><br>
					</div>
				</div>
				<div class="row">
