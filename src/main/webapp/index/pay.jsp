		...
		<div class="container">
			...
			<form class="form-horizontal" action="pay" method="post" id="payform">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<input type="tel" minlength="11" maxlength="11"
							...
							style="height: auto; padding: 10px;" placeholder="输入收货电话"
							required="required" id="fphone"><br>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" name="address"
							...
							placeholder="输入收货地址" required="required" id="faddress"><br>
					</div>
				</div>
					...
					<label>
						<div class="thumbnail">
							<input type="radio" name="paytype" value="2" /> <img
								src="images/alipay.jpg" alt="支付宝支付">
						</div>
					</label>
				</div>
				<div class="col-sm-6 col-md-4 col-lg-3 ">
				...
				<div class="register-but text-center">
					...
					<input type="submit" value="确认订单"><br>
					<br>
					<div class="clearfix"></div>
				</div>
			</form>
